...
pub fn run_nftoken_burn_preflight<Registry, Tx, Journal, ParentBatchId>(
...
pub fn run_nftoken_burn_preclaim<Registry, View, Tx, Journal, ParentBatchId>(
    _ctx: &PreclaimContext<Registry, View, Tx, Journal, ParentBatchId>,
) -> Ter {
    Ter::TES_SUCCESS
}

pub fn run_nftoken_burn_do_apply<Registry, BaseView, View, Tx, Fee, Journal, ParentBatchId>(
