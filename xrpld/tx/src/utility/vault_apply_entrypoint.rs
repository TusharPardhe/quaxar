//! Public vault-family `doApply(...)` composition shell above the landed
...
//!   types,
//! - and composes the landed generic apply shell at the public boundary.
...
use crate::{
    ...
    run_with_vault_txn_type_key, txn_type_of,
};

pub fn run_vault_apply_for_txn_type<Registry, BaseView, View, Tx, Fee, Journal, ParentBatchId, E>(
...
pub fn run_vault_apply_for_txn_source<
    Registry,
    BaseView,
    View,
    Tx,
