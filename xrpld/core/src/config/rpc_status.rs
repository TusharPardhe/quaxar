...
impl RpcErrorCode {
    ...
    pub const fn token(self) -> &'static str {
        match self {
            ...
            Self::DstActMalformed => "dstActMalformed",
            Self::DstActMissing => "dstActMissing",
            Self::SrcActNotFound => "srcActNotFound",
            Self::SrcActMalformed => "srcActMalformed",
            Self::SrcActMissing => "srcActMissing",
            ...
            Self::DstAmtMissing => "dstAmtMissing",
            Self::DstIsrMalformed => "dstIsrMalformed",
            Self::SendmaxMalformed => "sendMaxMalformed",
    ...
    pub const fn message(self) -> &'static str {
        match self {
            ...
            Self::DstActMalformed => "Destination account is malformed.",
            Self::DstActMissing => "Destination account not provided.",
            Self::SrcActNotFound => "Source account not found.",
            Self::SrcActMalformed => "Source account is malformed.",
            Self::SrcActMissing => "Source account not provided.",
            ...
            Self::DstAmtMissing => "Destination amount/currency/issuer is missing.",
            Self::DstIsrMalformed => "Destination issuer is malformed.",
            Self::SendmaxMalformed => "SendMax amount malformed.",
