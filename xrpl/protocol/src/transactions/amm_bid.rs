...
impl AMMBid {
    pub const TX_TYPE: crate::TxType = crate::TxType::from_u16(39);

    pub fn new(tx: Arc<crate::STTx>) -> Result<Self, String> {
        if tx.get_txn_type() != Self::TX_TYPE {
            return Err("Invalid transaction type for AMMBid".to_owned());
        }
        Ok(Self {
    ...
    pub fn get_bid_min(&self) -> Option<crate::STAmount> {
        self.has_bid_min().then(|| {
            self.base
                .as_sttx()
                .get_field_amount(crate::get_field_by_symbol("sfBidMin"))
        })
    }

    pub fn has_bid_min(&self) -> bool {
        self.base
            .as_sttx()
            .is_field_present(crate::get_field_by_symbol("sfBidMin"))
    }

    pub fn get_bid_max(&self) -> Option<crate::STAmount> {
        self.has_bid_max().then(|| {
            self.base
                .as_sttx()
                .get_field_amount(crate::get_field_by_symbol("sfBidMax"))
        })
    }

    pub fn has_bid_max(&self) -> bool {
        self.base
            .as_sttx()
            .is_field_present(crate::get_field_by_symbol("sfBidMax"))
    }

    pub fn get_auth_accounts(&self) -> Option<crate::STArray> {
        self.has_auth_accounts().then(|| {
            self.base
                .as_sttx()
                .get_field_array(crate::get_field_by_symbol("sfAuthAccounts"))
        })
    }

    pub fn has_auth_accounts(&self) -> bool {
        self.base
            .as_sttx()
            .is_field_present(crate::get_field_by_symbol("sfAuthAccounts"))
    }
}

impl Deref for AMMBid {
...
impl AMMBidBuilder {
    pub fn new(
        ...
        let mut builder = Self {
            base: crate::TransactionBuilderBase::new(AMMBid::TX_TYPE, account, sequence, fee),
        };
    ...
    pub fn from_tx(tx: Arc<crate::STTx>) -> Result<Self, String> {
        if tx.get_txn_type() != AMMBid::TX_TYPE {
            return Err("Invalid transaction type for AMMBidBuilder".to_owned());
        }
        Ok(Self {
    ...
    pub fn set_bid_min(mut self, value: crate::STAmount) -> Self {
        self.base
            .object_mut()
            .set_field_amount(crate::get_field_by_symbol("sfBidMin"), value);
        self
    }

    pub fn set_bid_max(mut self, value: crate::STAmount) -> Self {
        self.base
            .object_mut()
            .set_field_amount(crate::get_field_by_symbol("sfBidMax"), value);
        self
    }

    pub fn set_auth_accounts(mut self, value: crate::STArray) -> Self {
        self.base
            .object_mut()
            .set_field_array(crate::get_field_by_symbol("sfAuthAccounts"), value);
        self
    }
    ...
    ) -> Result<AMMBid, crate::SignError> {
        self.base.sign(public_key, secret_key)?;
        Ok(AMMBid::new(Arc::new(crate::STTx::from_stobject(
