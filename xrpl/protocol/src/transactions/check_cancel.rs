...
impl CheckCancel {
    pub const TX_TYPE: crate::TxType = crate::TxType::from_u16(18);

    pub fn new(tx: Arc<crate::STTx>) -> Result<Self, String> {
        if tx.get_txn_type() != Self::TX_TYPE {
            return Err("Invalid transaction type for CheckCancel".to_owned());
        }
        Ok(Self {
...
impl CheckCancelBuilder {
    pub fn new(
        ...
        let mut builder = Self {
            base: crate::TransactionBuilderBase::new(CheckCancel::TX_TYPE, account, sequence, fee),
        };
    ...
    pub fn from_tx(tx: Arc<crate::STTx>) -> Result<Self, String> {
        if tx.get_txn_type() != CheckCancel::TX_TYPE {
            return Err("Invalid transaction type for CheckCancelBuilder".to_owned());
        }
        Ok(Self {
    ...
    ) -> Result<CheckCancel, crate::SignError> {
        self.base.sign(public_key, secret_key)?;
        Ok(CheckCancel::new(Arc::new(crate::STTx::from_stobject(
