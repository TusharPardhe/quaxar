...
pub struct LoanDelete {
    base: crate::TransactionBase,
}

impl LoanDelete {
    pub const TX_TYPE: crate::TxType = crate::TxType::from_u16(81);

    pub fn new(tx: Arc<crate::STTx>) -> Result<Self, String> {
        if tx.get_txn_type() != Self::TX_TYPE {
            return Err("Invalid transaction type for LoanDelete".to_owned());
        }
        Ok(Self {
    ...
    pub fn get_loan_id(&self) -> basics::base_uint::Uint256 {
        self.base
            .as_sttx()
            .get_field_h256(crate::get_field_by_symbol("sfLoanID"))
    }
}

impl Deref for LoanDelete {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct LoanDeleteBuilder {
    base: crate::TransactionBuilderBase,
}

impl LoanDeleteBuilder {
    pub fn new(
        account: crate::AccountID,
        loan_id: basics::base_uint::Uint256,
        sequence: Option<u32>,
        fee: Option<crate::STAmount>,
    ) -> Self {
        let mut builder = Self {
            base: crate::TransactionBuilderBase::new(LoanDelete::TX_TYPE, account, sequence, fee),
        };
        builder = builder.set_loan_id(loan_id);
        builder
    }

    pub fn from_tx(tx: Arc<crate::STTx>) -> Result<Self, String> {
        if tx.get_txn_type() != LoanDelete::TX_TYPE {
            return Err("Invalid transaction type for LoanDeleteBuilder".to_owned());
        }
        Ok(Self {
    ...
    pub fn set_loan_id(mut self, value: basics::base_uint::Uint256) -> Self {
        self.base
            .object_mut()
            .set_field_h256(crate::get_field_by_symbol("sfLoanID"), value);
        self
    }
    ...
    ) -> Result<LoanDelete, crate::SignError> {
        self.base.sign(public_key, secret_key)?;
        Ok(LoanDelete::new(Arc::new(crate::STTx::from_stobject(
