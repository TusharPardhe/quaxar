...
impl EnableAmendment {
    pub const TX_TYPE: crate::TxType = crate::TxType::from_u16(100);

    pub fn new(tx: Arc<crate::STTx>) -> Result<Self, String> {
        if tx.get_txn_type() != Self::TX_TYPE {
            return Err("Invalid transaction type for EnableAmendment".to_owned());
        }
        Ok(Self {
    ...
    pub fn get_amendment(&self) -> basics::base_uint::Uint256 {
        self.base
            .as_sttx()
            .get_field_h256(crate::get_field_by_symbol("sfAmendment"))
    }
}

impl Deref for EnableAmendment {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct EnableAmendmentBuilder {
    base: crate::TransactionBuilderBase,
}

impl EnableAmendmentBuilder {
    pub fn new(
        account: crate::AccountID,
        ledger_sequence: u32,
        amendment: basics::base_uint::Uint256,
        sequence: Option<u32>,
        fee: Option<crate::STAmount>,
    ) -> Self {
        let mut builder = Self {
            base: crate::TransactionBuilderBase::new(
                EnableAmendment::TX_TYPE,
                account,
                sequence,
                fee,
            ),
        ...
        builder = builder.set_amendment(amendment);
        builder
    }

    pub fn from_tx(tx: Arc<crate::STTx>) -> Result<Self, String> {
        if tx.get_txn_type() != EnableAmendment::TX_TYPE {
            return Err("Invalid transaction type for EnableAmendmentBuilder".to_owned());
        }
        Ok(Self {
    ...
    pub fn set_amendment(mut self, value: basics::base_uint::Uint256) -> Self {
        self.base
            .object_mut()
            .set_field_h256(crate::get_field_by_symbol("sfAmendment"), value);
        self
    }
    ...
    ) -> Result<EnableAmendment, crate::SignError> {
        self.base.sign(public_key, secret_key)?;
        Ok(EnableAmendment::new(Arc::new(crate::STTx::from_stobject(
