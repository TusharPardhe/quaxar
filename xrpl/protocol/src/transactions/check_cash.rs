...
impl CheckCash {
    pub const TX_TYPE: crate::TxType = crate::TxType::from_u16(17);

    pub fn new(tx: Arc<crate::STTx>) -> Result<Self, String> {
        if tx.get_txn_type() != Self::TX_TYPE {
            return Err("Invalid transaction type for CheckCash".to_owned());
        }
        Ok(Self {
    ...
    pub fn get_check_id(&self) -> basics::base_uint::Uint256 {
        self.base
            .as_sttx()
            .get_field_h256(crate::get_field_by_symbol("sfCheckID"))
    }
...
impl CheckCashBuilder {
    pub fn new(
        ...
        check_id: basics::base_uint::Uint256,
        sequence: Option<u32>,
        fee: Option<crate::STAmount>,
    ) -> Self {
        let mut builder = Self {
            base: crate::TransactionBuilderBase::new(CheckCash::TX_TYPE, account, sequence, fee),
        };
        builder = builder.set_check_id(check_id);
        builder
    }

    pub fn from_tx(tx: Arc<crate::STTx>) -> Result<Self, String> {
        if tx.get_txn_type() != CheckCash::TX_TYPE {
            return Err("Invalid transaction type for CheckCashBuilder".to_owned());
        }
        Ok(Self {
    ...
    pub fn set_check_id(mut self, value: basics::base_uint::Uint256) -> Self {
        self.base
            .object_mut()
            .set_field_h256(crate::get_field_by_symbol("sfCheckID"), value);
        self
    }
    ...
    ) -> Result<CheckCash, crate::SignError> {
        self.base.sign(public_key, secret_key)?;
        Ok(CheckCash::new(Arc::new(crate::STTx::from_stobject(
