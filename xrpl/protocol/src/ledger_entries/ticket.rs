...
impl Ticket {
    pub const ENTRY_TYPE: crate::LedgerEntryType = crate::LedgerEntryType::Ticket;

    pub fn new(sle: Arc<crate::STLedgerEntry>) -> Result<Self, String> {
        if sle.get_type() != Self::ENTRY_TYPE {
            return Err("Invalid ledger entry type for Ticket".to_owned());
        }
    ...
    pub fn get_ticket_sequence(&self) -> u32 {
        self.base
            .as_st_ledger_entry()
            .get_field_u32(crate::get_field_by_symbol("sfTicketSequence"))
    }
...
impl TicketBuilder {
    pub fn new(
        ...
        let mut builder = Self {
            base: crate::LedgerEntryBuilderBase::new(Ticket::ENTRY_TYPE),
        };
        builder = builder.set_account(account);
        builder = builder.set_owner_node(owner_node);
        builder = builder.set_ticket_sequence(ticket_sequence);
    ...
    pub fn from_sle(sle: Arc<crate::STLedgerEntry>) -> Result<Self, String> {
        if sle.get_type() != Ticket::ENTRY_TYPE {
            return Err("Invalid ledger entry type for Ticket".to_owned());
        }
    ...
    pub fn set_ticket_sequence(mut self, value: u32) -> Self {
        self.base
            .object_mut()
            .set_field_u32(crate::get_field_by_symbol("sfTicketSequence"), value);
        self
    }
    ...
    pub fn build(self, index: Uint256) -> Ticket {
        Ticket::new(Arc::new(crate::STLedgerEntry::from_stobject(
