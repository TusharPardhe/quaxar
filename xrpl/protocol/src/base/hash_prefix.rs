...
pub enum HashPrefix {
    ...
    CounterpartyTxSign = make_hash_prefix('C', 'P', 'T'),
    CounterpartyTxMultiSign = make_hash_prefix('C', 'P', 'M'),
    SponsorTxSign = make_hash_prefix('S', 'P', 'N'),
    SponsorTxMultiSign = make_hash_prefix('S', 'P', 'M'),
