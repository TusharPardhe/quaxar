...
pub const PAYMENT_SPONSOR_CREATED_ACCOUNT_FLAG: FlagValue = 0x0008_0000;
pub const PAYMENT_FLAGS: FlagValue = PAYMENT_NO_RIPPLE_DIRECT_FLAG
    | PAYMENT_PARTIAL_PAYMENT_FLAG
    | PAYMENT_LIMIT_QUALITY_FLAG
    | PAYMENT_SPONSOR_CREATED_ACCOUNT_FLAG;
...
pub const MPT_SET_CAN_LOCK_ENABLE_FLAG: FlagValue = 0x0000_0004;
pub const MPT_SET_REQUIRE_AUTH_ENABLE_FLAG: FlagValue = 0x0000_0008;
pub const MPT_SET_CAN_ESCROW_ENABLE_FLAG: FlagValue = 0x0000_0010;
pub const MPT_SET_CAN_TRADE_ENABLE_FLAG: FlagValue = 0x0000_0020;
pub const MPT_SET_CAN_TRANSFER_ENABLE_FLAG: FlagValue = 0x0000_0040;
pub const MPT_SET_CAN_CLAWBACK_ENABLE_FLAG: FlagValue = 0x0000_0080;
pub const MPT_SET_CAN_HOLD_CONFIDENTIAL_BALANCE_ENABLE_FLAG: FlagValue = 0x0000_0100;
pub const MPT_ISSUANCE_SET_ENABLE_FLAGS: FlagValue = MPT_SET_CAN_LOCK_ENABLE_FLAG
    | MPT_SET_REQUIRE_AUTH_ENABLE_FLAG
    | MPT_SET_CAN_ESCROW_ENABLE_FLAG
    | MPT_SET_CAN_TRADE_ENABLE_FLAG
    | MPT_SET_CAN_TRANSFER_ENABLE_FLAG
    | MPT_SET_CAN_CLAWBACK_ENABLE_FLAG
    | MPT_SET_CAN_HOLD_CONFIDENTIAL_BALANCE_ENABLE_FLAG;
pub const MPT_ISSUANCE_SET_FLAGS: FlagValue =
    MPT_LOCK_FLAG | MPT_UNLOCK_FLAG | MPT_ISSUANCE_SET_ENABLE_FLAGS;
...
pub const SPONSORSHIP_CLEAR_REQUIRE_SIGN_FOR_RESERVE_FLAG: FlagValue = 0x0008_0000;
pub const DELETE_OBJECT_FLAG: FlagValue = 0x0010_0000;
pub const SPONSORSHIP_SET_FLAGS: FlagValue = SPONSORSHIP_SET_REQUIRE_SIGN_FOR_FEE_FLAG
    | SPONSORSHIP_CLEAR_REQUIRE_SIGN_FOR_FEE_FLAG
    | SPONSORSHIP_SET_REQUIRE_SIGN_FOR_RESERVE_FLAG
    | SPONSORSHIP_CLEAR_REQUIRE_SIGN_FOR_RESERVE_FLAG
    | DELETE_OBJECT_FLAG;
pub const SPONSORSHIP_SET_FLAGS_MASK: FlagValue = transaction_flags_mask(SPONSORSHIP_SET_FLAGS);

pub const SPONSORSHIP_END_FLAG: FlagValue = 0x0001_0000;
pub const SPONSORSHIP_CREATE_FLAG: FlagValue = 0x0002_0000;
pub const SPONSORSHIP_REASSIGN_FLAG: FlagValue = 0x0004_0000;
pub const SPONSORSHIP_TRANSFER_FLAGS: FlagValue =
    SPONSORSHIP_END_FLAG | SPONSORSHIP_CREATE_FLAG | SPONSORSHIP_REASSIGN_FLAG;
...
pub const MPT_CAN_HOLD_CONFIDENTIAL_BALANCE_IMMUTABLE_FLAG: FlagValue = 0x0000_0080;
pub const MPT_ISSUANCE_IMMUTABLE_MASK: FlagValue = !(MPT_CAN_MUTATE_CAN_LOCK_FLAG
    | MPT_CAN_MUTATE_REQUIRE_AUTH_FLAG
    | MPT_CAN_MUTATE_CAN_ESCROW_FLAG
    | MPT_CAN_MUTATE_CAN_TRADE_FLAG
    | MPT_CAN_MUTATE_CAN_TRANSFER_FLAG
    | MPT_CAN_MUTATE_CAN_CLAWBACK_FLAG
    | MPT_CAN_HOLD_CONFIDENTIAL_BALANCE_IMMUTABLE_FLAG
    | MPT_CAN_MUTATE_METADATA_FLAG
    | MPT_CAN_MUTATE_TRANSFER_FEE_FLAG);
...
alias_consts!(
    ...
    (PAYMENT_SPONSOR_CREATED_ACCOUNT_FLAG => tfSponsorCreatedAccount),
    ...
    (MPT_SET_CAN_LOCK_ENABLE_FLAG => tfMPTSetCanLock),
    (MPT_SET_REQUIRE_AUTH_ENABLE_FLAG => tfMPTSetRequireAuth),
    (MPT_SET_CAN_ESCROW_ENABLE_FLAG => tfMPTSetCanEscrow),
    (MPT_SET_CAN_TRADE_ENABLE_FLAG => tfMPTSetCanTrade),
    (MPT_SET_CAN_TRANSFER_ENABLE_FLAG => tfMPTSetCanTransfer),
    (MPT_SET_CAN_CLAWBACK_ENABLE_FLAG => tfMPTSetCanClawback),
    (MPT_SET_CAN_HOLD_CONFIDENTIAL_BALANCE_ENABLE_FLAG => tfMPTSetCanHoldConfidentialBalance),
    (MPT_ISSUANCE_SET_ENABLE_FLAGS => tfMPTokenIssuanceSetEnableFlagMask),
    ...
    (SPONSORSHIP_CLEAR_REQUIRE_SIGN_FOR_RESERVE_FLAG => tfSponsorshipClearRequireSignForReserve),
    (DELETE_OBJECT_FLAG => tfDeleteObject),
    (SPONSORSHIP_SET_FLAGS_MASK => tfSponsorshipSetMask),
    (SPONSORSHIP_END_FLAG => tfSponsorshipEnd),
    ...
    (MPT_CAN_MUTATE_CAN_LOCK_FLAG => tifMPTCanLock),
    (MPT_CAN_MUTATE_REQUIRE_AUTH_FLAG => tifMPTRequireAuth),
    (MPT_CAN_MUTATE_CAN_ESCROW_FLAG => tifMPTCanEscrow),
    (MPT_CAN_MUTATE_CAN_TRADE_FLAG => tifMPTCanTrade),
    (MPT_CAN_MUTATE_CAN_TRANSFER_FLAG => tifMPTCanTransfer),
    (MPT_CAN_MUTATE_CAN_CLAWBACK_FLAG => tifMPTCanClawback),
    (MPT_CAN_HOLD_CONFIDENTIAL_BALANCE_IMMUTABLE_FLAG => tifMPTCanHoldConfidentialBalance),
    (MPT_CAN_MUTATE_METADATA_FLAG => tifMPTMetadata),
    (MPT_CAN_MUTATE_TRANSFER_FEE_FLAG => tifMPTTransferFee),
    (MPT_ISSUANCE_IMMUTABLE_MASK => tifMPTokenIssuanceImmutableMask),
